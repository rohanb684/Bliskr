import ChildrenInput from "@/components/features/children/ChildrenInput";
...
const ChildrenPage = () => {
  return (
    <div className="w-full pb-4">
      <FormInputSection heading="Do you have any children?" subheading="">
        <ChildrenInput />
      </FormInputSection>
      ...
      <div className="w-full flex-center mt-8 sm:mt-18">
        <SkipBtn href="/preferences/religious-beliefs" />
      </div>
    </div>
  );
};
